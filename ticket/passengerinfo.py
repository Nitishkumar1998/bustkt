...
class PassengerRegistration():
    ...
    def getPassengerInfo(self):
        ...
        if self.dl == 1:
            self.departureLocation = "Macherla"
        elif self.dl == 2:
            self.departureLocation = "Rentachintala"
        elif self.dl == 3:
            self.departureLocation = "Manchikallu"
        elif self.dl == 4:
            self.departureLocation = "Guntur"
        else:
            print("Please Enter correct choice  :")
        # departure Location Name END
        
        print("1: Hyderabad MGBS")
        print("2: Ameerpet")
        print("3: KPHB Colony")
        print("4: Miyapur")
        ...
        if self.dpl == 1:
            self.destinationLocation = "Hyderabad MGBS"
        elif self.dpl == 2:
            self.destinationLocation = "Ameerpet"
        elif self.dpl == 3:
            self.destinationLocation = "KPHB Colony"
        elif self.dpl == 4:
            self.destinationLocation = "Miyapur"
        # Enter destination Location Name END

        self.ddmmyyyy = input("Enter Date of Joiurney Like 08-06-2023   :")  #Date of Journey
